...
- Fix: leftover next-surah pool scoring + prefer first usable ayah of the newly located surah. No Nas 7:1 / Baqarah 2:1 retune. Basmala-echo 55:1 unit still passes.
- `npm run test:replay -- jump` PASS (108:1–3 then 112:1–4; first Ikhlas lock 112:1@16.75s). JSON: `artifacts/qa-runs/replay-jump.json`.
- `kawthar` / `ikhlas` PASS. `npm test` 108/108.
- PR: do not merge.
