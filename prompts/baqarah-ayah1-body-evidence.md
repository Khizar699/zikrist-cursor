...
Mandatory regression gates: **nas**, fatiha, ikhlas, falaq, english-negative, basmala-hold, cold-start-mid, stall-after-lock, **asr**, **kawthar**, **quraysh**, **jump**, **back-to-back**. Main `11759a9` has jump and back-to-back Mac-green (jump came free from #5). `802bc66` Nas 114:6; `eacf963` Basmala-echo must keep `001001` from first-locking 55:1. The only remaining merge gate is Mac `npm run test:replay -- longer` first-lock **2:1**.
...
UI, model retune, Baqarah-only special case. Do not retune Nas last-ayah, Asr leftover, Kawthar/Quraysh, jump (Kawthar→Ikhlas), or back-to-back Asr→Quraysh leftover crumbs; they are regression gates after rebase onto `11759a9`.
...
3. The named regression gates stay green: nas, fatiha, asr, kawthar, quraysh, ikhlas, falaq, jump, back-to-back.
