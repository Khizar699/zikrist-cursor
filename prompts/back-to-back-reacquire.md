...
- `back-to-back` PASS: 103:1@1s, 103:2@8.75s, 103:3@9.25s, 106:1@21.75s, 106:2@27.25s, 106:3@31.25s, 106:4@40.5s; `failureMode` null. Asr does not re-lock 103:1 after 103:3.
- `asr`, `quraysh`, `fatiha`, `nas`, `kawthar`, `ikhlas`, `falaq`, `basmala-hold` PASS.
- `npm test` 118/118; typecheck pass. Not a physical-device or Mac-local claim.
