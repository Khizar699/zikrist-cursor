...
**Current MVP (Phase 1):** rock-solid, low-latency Arabic **mushaf tracking** during live salah. Lock `[surah:ayah]`, paint canonical Arabic, follow monotonically. **Phase 2 translation** is a static `[surah:ayah]` lookup after Arabic alignment is flawless — not current engineering (`AGENTS.md`, `prompts/mushaf-first-mvp.md`).
