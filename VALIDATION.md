...
| Suite | Result |
| --- | --- |
| `jump` | Linux leftover path locked 112:1@16.75s; **Mac Alafasy concat still failed** `sequence_break_at_3_got_112:4_expected_112:1` (108:1@7.5, 108:2@8.5, 108:3@9.5, 112:4@24.75). Follow-up: post-surah locate uses the 4 s acquire window (not 1.2 s follow). Linux@16.75s is not a Mac pass. |
